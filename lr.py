...
pipeline = Pipeline(steps=[
    ('scaler', scaler),
    ('classifier', LogisticRegression(max_iter=1000, class_weight={0:1, 1:2}))  # Sample weights are included in class_weight
])

# 4. Apply Logistic Regression with Sample Weights
